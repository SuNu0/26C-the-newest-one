...
关键矛盾是：降低当前购电费用与保留后续可用储能之间的跨时段权衡。首先统一功率、电量与时间索引，计算并识别出净负荷及光伏富余区间；其次建立购电、充放电和储能状态变量，以二元变量保证充放电状态互斥，并施加容量、功率及单日内首末储能相等的约束；最后先最小化购电费，通过约束回代和线性松弛下界检验方案。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.94\textwidth]{图2_净负荷分布与工作日差异.png}
    \caption{净负荷分布与工作日差异}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.94\textwidth]{图3_主要变量月度变化与相关关系.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth]{图4_问题一解题思路流程图.png}
    \caption{问题一解题思路流程图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{图5_问题一储能状态与充放电行为.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{图6_问题一有无储能购电策略对比.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.91\textwidth]{图7_问题一储能效率敏感性.png}
    \caption{问题一储能效率敏感性}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth]{图8_问题二求解流程图.jpg}
    \caption{问题二求解流程图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.93\textwidth]{图9_实际净负荷与日前预测误差.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.93\textwidth]{图10_动态分位数与应急购电月度分布.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{图11_时间顺序样本外预测检验.png}
    \caption{时间顺序样本外预测检验}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth]{图12_问题三求解流程图.jpg}
    \caption{问题三求解流程图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.96\textwidth]{图13_四时点滚动优化的信息更新机制.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.91\textwidth]{图14_日前计划与四时点滚动调整的典型日对比.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.91\textwidth]{图15_不同预报更新频率下的信息价值比较.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth]{图16_问题四求解流程图.png}
    \caption{问题四求解流程图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.93\textwidth]{图17_固定电价与波动电价分布对比.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{图18_四种调度策略的月度成本比较.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.91\textwidth]{图19_波动电价下滚动策略的典型日调度.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{图20_不同问题与调度策略的全年总成本比较.png}
