...
TOOLS_DIR = PROJECT_ROOT / "code" / "tools"

# 使用 Skill 提供的样式与正式导出器；这是为了统一字体、色盲安全配色和 300 DPI 输出。
sys.path.insert(0, str(PROJECT_ROOT))
sys.path.insert(0, str(TOOLS_DIR))
from plot_style import PALETTE, apply_publication_style, audit_design, audit_layout  # noqa: E402
...
def write_repro_manifest(params: Parameters) -> None:
    ...
    script = TOOLS_DIR / "repro_manifest.py"
    command = [
